#ifndef CHAINCHEMICALPOTENTIALINSERTION_H
#define CHAINCHEMICALPOTENTIALINSERTION_H
...
namespace GridMC
{
   ...
   * \ingroup Diag_Module
   */
   class ChainChemicalPotentialInsertion: public Diagnosis
   {
   ...
   public:
      ...
      * Default constructor.
      */
      ChainChemicalPotentialInsertion(System& sysIn);

      /**
      * Default destructor.
      */
      virtual ~ChainChemicalPotentialInsertion();
